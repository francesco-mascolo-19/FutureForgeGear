...
<%@ page import="java.util.*, model.OrderManagement.Prodotto, model.OrderManagement.Cart, model.immagine, model.ProductDao" %>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="img1" id="zoomableImageContainer">
                <img src="data:image/jpg;base64, <%= Base64.getEncoder().encodeToString(product.getImage()) %>" alt="Immagine prodotto principale" width="400px" id="ProductImg" data-zoomable>
            </div>
            <br>
