...
<div class="container-home">
    <div class="header-Home">
        <h1>Benvenuti su FutureForgeGear</h1>
    </div>

    <!-- Carosello -->
    <div class="ekw_carousel_container">
        <div class="ekw_content_container">
            <div><img src="image/carosello1.jpg" alt="Image 1"></div>
            <div><img src="image/carosello2.jpg" alt="Image 2"></div>
            <div><img src="image/carosello3.jpg" alt="Image 3"></div>
            <div><img src="image/carosello4.jpg" alt="Image 4"></div>
        </div>
    </div>

    <div class="category-container">
        <div class="category-box">
            <a href="Product.jsp?categoria=Fissi">
                <img src="image/pcfisso1.jpg" alt="Categoria Fissi">
                <h2>Fissi</h2>
            </a>
        </div>
        <div class="category-box">
            <a href="Product.jsp?categoria=Portatile">
                <img src="image/pcportatile1.jpg" alt="Categoria Portatili">
                <h2>Portatili</h2>
            </a>
        </div>
        <div class="category-box">
            <a href="Product.jsp?categoria=Periferiche">
                <img src="image/periferiche1.jpg" alt="Categoria Periferiche">
                <h2>Periferiche</h2>
            </a>
        </div>
        <div class="category-box">
            <a href="tuttiProdotti.jsp">
                <img src="image/tutti.jpeg" alt="Tutti i prodotti">
